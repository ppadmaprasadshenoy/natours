...
// const tours = JSON.parse(fs.readFileSync(`${__dirname}/../dev-data/data/tours-simple.json`)); // Was for testing with json files. No longer needed

// Below function no longer needed because Mongo itself will throw error if id not found
